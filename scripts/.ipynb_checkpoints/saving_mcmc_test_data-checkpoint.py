...
np.save('/data/notebooks/jupyterlab-biascorrlab/data/multi_site_jan_precip.npy',jan_sample_data)
np.save('/data/notebooks/jupyterlab-biascorrlab/data/multi_site_feb_precip.npy',feb_sample_data)