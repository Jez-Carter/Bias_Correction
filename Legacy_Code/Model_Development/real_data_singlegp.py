...
idata_prior = az.from_numpyro(mcmc_prior).posterior.drop_vars('data')
...
outfile_dir = '/home/jez/Bias_Correction/data/Residual_Model/'
idata_prior = az.from_netcdf(f'{outfile_dir}idata_residual_singlegp_prior.nc')
...
# %%
az.plot_density(idata_prior, figsize=(5, 3))
plt.tight_layout()
plt.show()
# %%
onoise = 1
...
difference_matern32 = realisations_matern32.mean(axis=(0,1))-odata
difference_expsq = realisations_expsq.mean(axis=(0,1))-odata
